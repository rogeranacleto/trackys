    ...
    return(
        <div className="w-screen h-screen bg-[#000] flex flex-col justify-center items-center p-5">
            <section className="flex flex-col max-w-2xl w-full relative">
                ...
                <FaRegUser className="absolute text-[#a6ff00af] text-xl top-34 left-5"/>
                <input type="email" placeholder="Digite um nome de usuário" className="border border-solid border-[#a6ff00af] text-[#a6ff00] focus:outline-none focus:shadow-lg focus:ring-2 focus:ring-[#a6ff00] transition-shadow duration-300 pt-2.5 pb-2.5 pl-15 mb-10"/>
                <label className="text-white mb-2">Email</label>
               <MdOutlineMail className="absolute text-[#a6ff00af] text-2xl top-63 left-5"/> 
                ...
                <input type="password" placeholder="Crie uma senha senha" className="border border-solid border-[#a6ff00af] text-[#a6ff00] focus:outline-none focus:shadow-lg focus:ring-2 focus:ring-[#a6ff00] transition-shadow duration-300 pt-2.5 pb-2.5 pl-15 mb-10 w-full"/>
