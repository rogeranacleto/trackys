...
useEffect(() => {
    ...
    <div style={{cursor: `url(${logoCursor})16 16, auto`}}>
        ...
        <section className="w-screen min-h-screen bg-[#000] relative">
            <section className="relative z-10 flex justify-center top-60 right-5.5 p-5 flex-col items-center">
                <div className="max-w-4xl flex flex-col justify-center items-center">
                    <h1 data-aos="fade-up" data-aos-duration="2300" className="text-[#ffffffcb] text-6xl lg:text-7xl text-center max-sm:text-left font-medium ml-6 max-sm:ml-15">Controle seus envios de maneira rápida e eficiente</h1>
                    <p data-aos="fade-up" data-aos-duration="2200" className="text-[#A1A1AA] text-2xl max-w-3xl ml-15 mt-8 lg:text-center mr-15">
            ...
            <div data-aos="fade-up" data-aos-duration="2000" className="relative flex items-center justify-center min-h-screen mt-20 p-8">
                <img
                    ...
                    className="max-w-7xl w-full object-contain border border-solid border-[#ffffff44] rounded-2xl shadow-[0_0_1000px_#a6ff0036] hover:shadow-[0_0_1100px_#a6ff0036,0_0_900px_#a6ff0036] transition-all duration-700"
                />
            </div>
        </section>
        ...
        <div className="flex flex-wrap max-w-6xl w-full gap-10">
            ...
            <h2 className="text-[#ffffffdc] text-4xl md:text-5xl lg:text-5xl font-medium leading-15 relative lg:text-center">
            ...
            <p className="text-[#A1A1AA] max-w-lg text-lg leading-8 lg:text-center min-md:ml-25">
        ...
        <section className="bg-[#000] text-[#ffffffdc] px-8 py-16 mb-15">
            ...
            <div data-aos="zoom-in-up" data-aos-duration="2500" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto gap-8 ">
                <div className="bg-[#151419] p-6 flex flex-col max-w-[420px] min-h-[480px] border border-solid border-[#ffffff44] rounded-2xl shadow-[0_0_90px_#a6ff0036] hover:shadow-[0_0_100px_#a6ff0036,0_0_110px_#a6ff0036] hover:scale-110 transition-all duration-400 max-sm:m-auto">
            ...
            <div data-aos="zoom-in-up" data-aos-duration="2400" className="grid grid-cols-1 lg:grid-cols-2 max-w-6xl mx-auto gap-8 mt-8">
                <div className="bg-[#151419] p-6 flex flex-col border border-solid border-[#ffffff44] rounded-2xl shadow-[0_0_90px_#a6ff0036] hover:shadow-[0_0_100px_#a6ff0036,0_0_110px_#a6ff0036] hover:scale-110 transition-all duration-400 max-sm:m-auto">
                    <div className="mt-8">
                        <img src={dashboardimg} alt="" className="rounded-lg w-full" />
                    </div>
