...
useEffect(() => {
    ...
    <div>
        ...
        <div className="flex flex-wrap max-w-6xl w-full gap-10">
            ...
            <h2 className="text-[#dedede] text-4xl md:text-5xl lg:text-5xl font-medium leading-15 relative lg:text-center">
                Quer ter total controle sobre suas entregas? Vamos juntos
            </h2>
            <div className=" relative hover:scale-110 duration-400 ease-in-out hidden lg:block mt-5">
                <p className=" fixed right-10 bg-[#dedede] text-[#000] p-2 lg:text-5xl font-medium">Trackys</p>
            ...
            <p className="text-[#dedede88] max-w-lg text-lg leading-8 lg:text-center min-md:ml-25">
                A <span className="font-bold text-[#dedede]">Trackys</span> conta com uma solução completa de gestão de entregas terceirizadas, projetada para otimizar operações e melhorar a experiência do cliente.
        ...
        <section className="bg-[#000] text-[#ffffffdc] px-8 py-16 mb-15">
            <div data-aos="zoom-in-up" data-aos-duration="2600" className="max-w-6xl mx-auto mb-12">
                <h2 className="text-[#dedede] text-4xl md:text-5xl lg:text-5xl font-medium leading-15 max-sm:text-center">O que a Trackys<br />oferece?</h2>
                <p className="text-[#dedede88] mt-5 max-w-lg text-lg leading-8 max-sm:text-center">
