        ...
        <div>
            <div data-aos="zoom-in" data-aos-duration="1000" className="w-screen h-screen bg-[#000] flex flex-col justify-center items-center p-5">
                <section className="flex flex-col max-w-2xl w-full relative">
                    ...
                    <input type="password" placeholder="Insira sua senha" className="border border-solid border-[#a6ff00af] text-gray-100/60 focus:outline-none focus:shadow-lg focus:ring-2 focus:ring-[#a6ff00] transition-shadow duration-300 pt-2.5 pb-2.5 pl-15 mb-10 w-full"/>
